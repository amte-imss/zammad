...
$lang['datatable_secciones_config'] = array(
    'nom_elemento_seccion' => ['label' => 'Sub sección', 'nom_tipo_campo' => 'text', 'nombre' => 'nom_elemento_seccion'],
    'id_validacion_registro' => ['label' => 'Estado de validación', 'nom_tipo_campo' => 'select', 'nombre' => 'id_validacion_registro'],
//    'acciones' => ['label' => 'Acciones', 'nombre' => 'acciones', 'nombre_tipo_campo' => 'template'],
);
